// // import Planning from '../server/models/Planning';
// // import mongoose from 'mongoose';
//
// // mongoose.connect('mongodb://localhost:27017/markPlanning');
//
// let data = {
//     data: [
...
//     return myData;
//
//     // data = axios.get('http://localhost:4200/planning')
//     //     .then(response => {
...
//     //
//     //     let dbo = db.db("markPlanning");
//     //     dbo.collection("plannings").count({}, function(err, num) {
//     //         let count = JSON.stringify(num);
//     //         console.log(count);
//     //
//     //     });
//     //     dbo.collection("plannings").find({}).toArray(function(err, docs) {
//     //         let s_docs = JSON.stringify(docs);
//     //         console.log(s_docs);
//     //         db.close();
...
//     // });
//     //
//     // Planning.find((err, planning) => {
//     //     if (err) return planning.json({success: false, error: err});
//     //     return planning.json({success: true, data: planning});
//     // });
//
// }
//
